                        ...
                        @if ($carts->count() > 0)
                            <form method="post" action="checkout1.html">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-select form-select-sm" aria-label=".form-select-sm example">
                                                        <option selected>Qty :{{ $product->pivot->quantity }}</option>
                                                ...
                                                <td>
                                                    <a href="{{ route('carts.delete',$product->id) }}"><i class="fa fa-trash-o"></i></a>  
                                                </td>
                                            </tr>
                                            @foreach ($discountedProducts as $sale)
                                            @if ($sale->name_en == $product->name_en)
                                ...
                                <div class="box-footer d-flex justify-content-between flex-column flex-lg-row">
                                    ...
                                    <div class="right">
                                        <a href="{{ route('order.checkout') }}" class="btn btn-primary">Proceed to checkout <i class="fa fa-chevron-right"></i></a>
                                    </div>
                                </div>
                            </form>
                        @else
